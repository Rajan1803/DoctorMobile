...
class ProfileAdapter: RecyclerView.Adapter<ProfileAdapter.ProfileHolder>() {
    class ProfileHolder(val binding: RecyclerProfileBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileHolder {
        return ProfileHolder(RecyclerProfileBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
